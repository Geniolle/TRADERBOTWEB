...
export default function DashboardPage() {
  ...
  const candlesError = useMemo(() => {
    ...
    if (
      ...
      return "Nenhum candle foi devolvido para esta seleÃ§Ã£o.";
    }

    if (wsStatus === "error") {
      return "Erro na ligaÃ§Ã£o websocket do grÃ¡fico.";
    }
  ...
  const debugItemStyle: CSSProperties = {
    ...
    >
      ...
      >
        ...
        {showSelectedStrategyNotice && selectedStrategyNotice && (
          ...
          >
            <strong>EstratÃ©gia selecionada para o grÃ¡fico:</strong>{" "}
            ...
            <br />
            <strong>Overlays desta estratÃ©gia:</strong>{" "}
            {selectedStrategyNotice.supportsOverlays
              ? "suportados"
              : "nÃ£o suportados"}
            <br />
            {selectedStrategyNotice.supportsOverlays
              ? "Os overlays estratÃ©gicos sÃ³ aparecem quando a estratÃ©gia escolhida no storage coincide com a estratÃ©gia do run selecionado."
              : "Esta estratÃ©gia continua referenciada apenas para visualizaÃ§Ã£o de overlays, mas o contrato devolvido pelo backend indica que nÃ£o hÃ¡ overlays estratÃ©gicos para desenhar no grÃ¡fico."}
          </div>
        )}
